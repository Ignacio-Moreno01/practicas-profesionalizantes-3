...
class view 
{
    constructor() 
    {
        ...
        this.btnSubstract.id = "btnSubstract";
        ...
        this.btnMultiply.id = "btnMultiply";
        ...
        this.btnCalculate.id = "btnCalculate";
        ...
        // this.container.appendChild(this.btnPlus);

        // this.container.appendChild(this.btn4);
        // this.container.appendChild(this.btn5);
        // this.container.appendChild(this.btn6);
        // this.container.appendChild(this.btnSubstract);

        // this.container.appendChild(this.btn7);
        // this.container.appendChild(this.btn8);
        // this.container.appendChild(this.btn9);
        // this.container.appendChild(this.btnMultiply);

        // this.container.appendChild(this.btn0);
        // this.container.appendChild(this.btnPoint);
        // this.container.appendChild(this.btnCalculate);
        // this.container.appendChild(this.btnDivide);

        // this.container.appendChild(this.btnC);
